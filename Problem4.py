...
class Patient:
    ...
    def get_total_cost(self):
        """ :returns total cost """
        return self._stateMonitor.get_total_cost()
...
class PatientStateMonitor:
    ...
    def __init__(self, parameters):
        ...
        self._timeToSTROKE = 0        # time to develop STROKE
    ...
    def get_total_cost(self):
        """ :returns total cost """
        return self._costUtilityOutcomes.get_total_cost()
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        for patient in simulated_cohort.get_patients():
            ...
            # cost and utility
            self._costs.append(patient.get_total_cost())
        ...
        self._sumStat_cost = StatCls.SummaryStat('Patient cost', self._costs)
